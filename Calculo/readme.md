...
1. Configuración básica y primeros comandos:  
   Inicia el entorno limpio (`clc`, `clear`, `close all`), muestra cómo usar `disp` para imprimir mensajes y presenta la asignación de variables y operaciones aritméticas, incluyendo el uso de paréntesis para controlar la precedencia.
