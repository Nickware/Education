...
# identificar las componentes sinusoidales principales y visualiza tanto la señal temporal como las componentes identificadas.
# Asegúrarse de tener el archivo 'test.wav' en el mismo directorio que
...
# Para ejecutar este código, asegúrarte de tener Octave instalado y los paquetes necesarios cargados. Puede instalar los paquetes utilizando el comando 'pkg install' en Octave.

# Ejemplo de uso:
# 1. Guardar este código en un archivo llamado 'wave_v.2.m'.
