// surface_plot.cpp
// This program generates a 3D surface plot of the function z = sin(sqrt(x^2 + y^2)) / sqrt(x^2 + y^2) using gnuplot. 
// It creates a data file and a gnuplot script, then executes the script to display the plot
